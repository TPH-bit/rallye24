    ...
    return (
      <div style={{ maxWidth: 420, margin: "60px auto", padding: 20 }}>
        ...
        <form onSubmit={signIn} style={{ display: "grid", gap: 10, background: "#1b2230", padding: 12, borderRadius: 8 }}>
          <input placeholder="Email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} style={{ padding: 10, borderRadius: 6, border: "1px solid #2b3445" }} />
          <input placeholder="Mot de passe" type="password" value={password} onChange={(e) => setPassword(e.target.value)} style={{ padding: 10, borderRadius: 6, border: "1px solid #2b3445" }} />
